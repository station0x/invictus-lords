         ...
         <!-- <div class="col-span-3 justify-between items-center w-full lg:flex lg:w-auto lg:order-1 lg:col-span-1">
                    ...
                    <nav>
                        <div class="col-span-3 justify-between items-center w-full lg:flex lg:w-auto lg:order-1 lg:col-span-1" id="mobile-menu-2">
                            <ul class="flex mt-0 font-medium space-x-4 lg:flex-row lg:space-x-8 lg:mt-0">
                                <li>
                                    <a @click="$router.push('/')" class="flex mr-8 items-left lg:justify-left lg:order-1 cursor-pointer">
                                        <!-- <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" /> -->
                                        <svg  class="-mr-6 ml-2 lg:ml-0 lg:mr-3 h-9" viewBox="0 0 22 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span v-if="!isConnected" class="hidden lg:flex self-center text-xl font-semibold whitespace-nowrap dark:text-white">Invictus Lords</span>
                                    </a>
                                </li>
                                <li class="hidden lg:flex" v-if="!isConnected || !isApp" >
            ...
            <nav class="items-center space-x-3 lg:flex">
            ...
            <nav v-if="isConnected" class="flex items-center space-x-3 lg:flex">
                ...
                <button type="button" class="py-2 ml-3 lg:ml-5 mr-1.5 flex col-span-2 justify-around items-center lg:order-3 lg:col-span-1 p-2 text-sm text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-invictus-gray-100 dark:bg-invictus-gray-700 dark:hover:bg-invictus-gray-700 dark:hover:text-white">
                    <span class="sr-only">Open user menu</span>
                ...
                <form class="cursor-default mr-5">   
                    <div class="relative">
                        ...
                        <input type="search" :value="rewardsFormatted" readonly 
                        class="flex col-span-2 w-full md:w-full justify-around items-center lg:order-2 lg:col-span-1 cursor-default pl-[44px] h-11 text-sm text-gray-900 bg-invictus-gray-50 rounded-lg border border-gray-300 focus:ring-invictus-gray-500 focus:border-invictus-gray-500 dark:bg-invictus-gray-900 dark:border-invictus-gray-600 dark:text-white dark:focus:ring-invictus-gray-500">
