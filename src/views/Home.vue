<template>
  <div>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-28 lg:px-12">
        ...
        <a v-else href="https://t.me/invictuslords" target="_blank" class="inline-flex justify-between items-center md:text-xs sm:font-light md:py-0 py-1 px-1 pr-4 mt-10 mb-7 text-sm text-gray-700 bg-invictus-gray-100 rounded-full dark:bg-invictus-gray-800 dark:text-white hover:bg-invictus-gray-200 dark:hover:bg-invictus-gray-700" role="alert">
            <span class="text-xs bg-invictus-gray-300 rounded-full text-gray-800 px-4 py-1.5 mr-3 font-bold">Beta</span> <span class="text-sm font-medium">This is a beta version on the Ethereum Mainnet. Please report any bugs at our telegram.</span> 
            <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
        </a>
