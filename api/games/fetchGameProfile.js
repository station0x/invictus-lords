...
module.exports = async (req, res) => {
    ...
    if(!playerDocRaw) res.status(404).json({sucess: false}) //throw new Error('Player does not exist')
        ...
        // if(Date.now() > Date.now() - 100) {
            ...
            try {
                ...
                * newPlayerGameDoc.gameInfo['headshotPct'].value).toFixed(0))
                ...
                console.log(newPlayerGameDoc.seasonalRating, newPlayerGameDoc.rating)
