...
async function resetDailyStats(address, game) {
    ...
    delete playerDoc.steam
        ...
        // if(Date.now() > Date.now() - 100) {
            ...
            try {
                ...
                console.log(formattedLatestData)
                ...
                newPlayerGameDoc.dailyGameInfo['kd'].value = 0
                newPlayerGameDoc.dailyGameInfo['shotsAccuracy'].value = 0
                newPlayerGameDoc.dailyGameInfo['wlPercentage'].value = 0
                newPlayerGameDoc.dailyGameInfo['headshotPct'].value = 0
